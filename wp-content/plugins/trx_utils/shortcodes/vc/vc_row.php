...
if (function_exists('vc_map_get_attributes')) {						// New VC
	 ...
	 * @var $scheme		- added by BugsPatrol
	 * @var $inverse	- added by BugsPatrol
	 * @var $atts
	 * @var $el_class
	 * @var $full_width
	 * @var $full_height
	...
	// Added by BugsPatrol:
	// Color scheme
	if ($scheme && !bugspatrol_param_is_off($scheme) && !bugspatrol_param_is_inherit($scheme)) $css_classes[] = 'scheme_'.esc_attr($scheme);
	// Inverse colors
	if ($inverse && !bugspatrol_param_is_off($inverse)) $css_classes[] = 'inverse_colors';
	...
	// Add BugsPatrol color scheme in the row
	if ($scheme && !bugspatrol_param_is_off($scheme) && !bugspatrol_param_is_inherit($scheme)) $css_class .= ' scheme_'.esc_attr($scheme);
	...
	} ?> <?php bugspatrol_show_layout($style); ?>><?php
	echo wpb_js_remove_wpautop( $content );
	?></div><?php bugspatrol_show_layout($this->endBlockComment('row'));
	if ( ! empty( $full_width ) ) {
