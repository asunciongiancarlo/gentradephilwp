...
if ( !function_exists( 'bugspatrol_template_news_portfolio_theme_setup' ) ) {
	add_action( 'bugspatrol_action_before_init_theme', 'bugspatrol_template_news_portfolio_theme_setup', 1 );
	function bugspatrol_template_news_portfolio_theme_setup() {
		bugspatrol_add_template(array(
			'layout' => 'news-portfolio',
			'template' => 'news-portfolio',
			'mode'   => 'news',
			'title'  => esc_html__('Recent News /Style Portfolio/', 'bugspatrol'),
...
// Template output
if ( !function_exists( 'bugspatrol_template_news_portfolio_output' ) ) {
	function bugspatrol_template_news_portfolio_output($post_options, $post_data) {
